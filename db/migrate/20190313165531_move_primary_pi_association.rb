    ...
    if sparc_protocols.is_a?(String)
      ...
      ActiveRecord::Base.transaction do
        ...
        PrimaryPi.all.each do |primary_pi|
          ...
          elsif (sparc_protocol = sparc_protocols[protocol.sparc_id]) && sparc_protocol['first_name'] == primary_pi.first_name && sparc_protocol['last_name'] == primary_pi.last_name && (ldap_results = LdapSearch.new.info_query(sparc_protocol['ldap_uid'].gsub('@musc.edu', ''), true, true)) && ldap_results.count == 1
